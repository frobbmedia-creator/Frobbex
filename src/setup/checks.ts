...
const DEFINITIONS: Array<{
  ...
  { id: "cua-binary", key: "cuaBinary", label: "Cua Driver binary", required: true, remediation: "Install Cua Driver and ensure `cua-driver` is on your PATH. See https://github.com/trycua/cua" },
